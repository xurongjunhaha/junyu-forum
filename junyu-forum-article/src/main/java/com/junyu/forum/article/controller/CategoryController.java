...
public class CategoryController {
    ...
    @PostMapping("/search") // 请求路径： 192.168.0.11:8001/article/category/search
    ...
    @GetMapping("/{id}") // 192.168.0.11:8001/article/category/{id}
    ...
    @GetMapping("/list") // 请求 192.168.0.11:8001/article/category/list
    public Result list() {
        return categoryService.findAllNormal();
    }

    @ApiOperation("查询正常状态的分类及分类下的所有标签接口")
    @GetMapping("/label/list") // 192.168.0.11:8001/article/category/label/list
