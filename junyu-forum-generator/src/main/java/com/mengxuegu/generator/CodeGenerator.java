...
public class CodeGenerator {
    ...
    // 数据库名称
    private static String DATABASE_NAME = "junyu_blog_system";
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://192.168.0.11:3306/"+ DATABASE_NAME +"?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=GMT%2B8");
        ...
        strategy.setTablePrefix("junyu_"); // 去掉表前缀
